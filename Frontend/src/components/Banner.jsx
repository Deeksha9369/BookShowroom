        ...
        <div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32  '>
          <div className='space-y-12'>
            <h1 className='text-4xl font-bold'>
              Hello, welcome here to learn something <span className='text-blue-800'>new everyday!!</span>
            </h1>
            <p className='text-xl'>
            ...
            <button className="btn btn-active btn-primary" style={{ width: '150px'}}>Submit</button>
          </div>
        </div>
        <div className='order-1 w-full md:w-1/2 mt-12 md:mt-32'>
          <img src={banner} className='w-100 h-100' alt='Banner' />
        </div>
      </div>
    </>
  );
